...
*/
console.log("task 1b:", createMenuItem("pizza", 5, "dinner"));
console.log("task 1b:", createMenuItem("pancakes", 2, "breakfast"));
console.log("task 1b:", createMenuItem("water", 1, "drink"));
...
*/
reviews[7].feedback = "this place is chill with really cool people, great for getting work done on weekends";
